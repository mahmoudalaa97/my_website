...
export default function ContactSection({ settings }: ContactSectionProps) {
    ...
    const contactInfo = [
        ...
        },
        {
            icon: Phone,
            label: 'WhatsApp',
            value: settings?.phone || '+1 (234) 567-8900',
            href: settings?.whatsapp ? `https://wa.me/${settings.whatsapp.replace(/\D/g, '')}` : 'https://wa.me/12345678900',
        },
        {
            icon: MapPin,
            label: 'Location',
    ...
    const socialLinks = [
        { icon: Linkedin, href: settings?.socialLinks?.linkedin || 'https://linkedin.com/in/yourprofile', label: 'LinkedIn' },
        { icon: Github, href: settings?.socialLinks?.github || 'https://github.com/yourprofile', label: 'GitHub' },
        { icon: Twitter, href: settings?.socialLinks?.twitter || 'https://twitter.com/yourprofile', label: 'Twitter' },
