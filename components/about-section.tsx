                ...
                <div className="grid gap-16 lg:grid-cols-2 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                            I&apos;m a passionate software developer dedicated to helping businesses 
                            embrace technology. With expertise in web and mobile development, 
                        ...
                        <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
                            ...
                            of business needs. Whether you&apos;re looking to digitize operations, 
                            build a new product, or modernize existing systems — I&apos;m here to help 
                            you succeed in the digital age.
                        </p>
